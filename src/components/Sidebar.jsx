  ...
  return (
    <div className={`fixed top-0 left-0 h-full ${isOpen ? 'w-64' : 'w-20'} bg-pink-300 transition-all duration-300 shadow-lg rounded-r-xl`}>
      <div className="flex items-center justify-center py-4">
        <img src={logoWecare} className="w-10 h-10" />
      ...
      <ul className="mt-10 space-y-4">
        <li className="flex items-center space-x-4 p-2 hover:bg-pink-400 cursor-pointer">
          <i className="text-red-600 text-2xl fas fa-home"></i>
          {isOpen && <span className="text-white">Home</span>}
        </li>
        <li className="flex items-center space-x-4 p-2 hover:bg-pink-400 cursor-pointer">
          <i className="text-red-600 text-2xl fas fa-clipboard"></i>
          {isOpen && <span className="text-white">Test</span>}
        </li>
        <li className="flex items-center space-x-4 p-2 hover:bg-pink-400 cursor-pointer">
          <i className="text-red-600 text-2xl fas fa-users"></i>
